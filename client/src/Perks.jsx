export default function Perks({selected, onChange}) {
  ...
  return (
    ...
    <>
      <label className="border p-4 flex rounded-2xl gap-2 iteams-center cursor-pointer">
      ...
      <label className="border p-4 flex rounded-2xl gap-2 iteams- cursor-pointer">
      ...
      <label className="border p-4 flex rounded-2xl gap-2 iteams-center cursor-pointer">
        <input type="checkbox" checked={selected.includes('RADIO')} name="RADIO" onChange={handleCdClick}/>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="currentColor"
